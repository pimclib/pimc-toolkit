...
TEST_F(IPv4AddressTests, MulticastAddresses) {
    net::IPv4Address lastUcast{223,255,255,255};
    EXPECT_FALSE(lastUcast.isMcast());
    net::IPv4Address firstMcast{224,0,0,0};
    EXPECT_TRUE(firstMcast.isMcast());
    net::IPv4Address lastMcast{239,255,255,255};
    EXPECT_TRUE(lastMcast.isMcast());
    net::IPv4Address firstMarsian{240,0,0,0};
    EXPECT_FALSE(firstMarsian.isMcast());
}

TEST_F(IPv4PrefixTests, PrefixComparisons) {
    auto p1 = net::IPv4Prefix::make(net::IPv4Address{10, 1, 3, 3}, 24);
    auto p2 = net::IPv4Prefix::make(net::IPv4Address{10, 1, 3, 0}, 24);
    auto p3 = net::IPv4Prefix::make(net::IPv4Address{10, 1, 3, 128}, 26);
    auto p4 = net::IPv4Prefix::make(net::IPv4Address{10, 1, 2, 0}, 23);
