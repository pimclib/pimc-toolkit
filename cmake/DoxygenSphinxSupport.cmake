...
function(DoxyLib TargetName LIB_NAME DOXY_LIB_DEPS_VN BREATHE_PROJECT_XML_DEFS_VN DOXYGEN_INDEX_LIST_VN)
    ...
    set(DOXYGEN_LIB_OUTPUT_DIR ${CMAKE_CURRENT_BINARY_DIR}/${TargetName}/doxygen/${LIB_NAME})
...
#  - TargetName: the name of the API documentation target, e.g. api-docs
#  - The library target name: e.g. PimcLib
#  - The subdirectory where the API RST sources reside, e.g. api-sources
#  - A number or RST files which references the generated API
#
# This function creates two targets, one called ${LibName}-Doxygen and
# the other ${TargetName}. The latter depends on the former.
# To generate the API documeentation one runs 'make api-docs' providing `api-docs`
# is the value of the argument TargetName
function(SphinxDoxyLib TargetName LibName SourceSubdir)
    set(DOXY_LIB_DEPS)
    set(BREATHE_PROJECT_XML_DEFS)
    set(DOXYGEN_INDEX_LIST)
    DoxyLib(${TargetName} ${LibName} DOXY_LIB_DEPS BREATHE_PROJECT_XML_DEFS DOXYGEN_INDEX_LIST)
